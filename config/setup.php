...
$sql_insertusers = "INSERT INTO users (fullname, name, email, gender, dateofbirth, msg, bio, rating, imagecount, address, neighbourhood, city, country, preference, password, status, confirmation_code) VALUES"
			...
			."('Tenten Tamura', 'Tenten', 'tenten@konoha.com', 'female', '1980-03-02', 'tenten§matches', 'Tenten (テンテン, Tenten) is a kunoichi from Konohagakure and a member of Team Guy. While initially wanting to be like the legendary Sannin Tsunade, she realised that she did not have the necessary chakra control to be a medical-nin.', '0', '0', 'The Hidden Leaf', 'Konoha', 'Johannesburg', 'South Africa', 'female', 'f82a7d02e8f0a728b7c3e958c278745cb224d3d7b2e3b84c0ecafc5511fdbdb7', 'activated', 'aa57b005e032da3b2f9f0b5e9ad40e50'),"
...
$sql_insertimages = "INSERT INTO images (image_name, image_type, image_creator, image_creator_email, image_likes, image_url) VALUES"
			...
			."('Hatake-profile.png', 'profile', 'Hatake', 'khatake@konoha.com', '0', './images/user_images/Kakashi-profile.png'),"
